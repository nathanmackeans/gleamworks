...
const footerLinks = {
  ...
  Support: [
    ...
    { name: "WhatsApp", href: "https://wa.me/2348089437077" },
    { name: "Call Us", href: "tel:08089437077" },
  ],
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 leading-relaxed mb-6">
              Professional cleaning services that transform spaces into
              spotless sanctuaries. Quality you can trust.
            </p>
            {/* Social Icons */}
            <div className="flex gap-4">
              ...
              <a
                href="#"
                className="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center hover:bg-[#E4405F] transition-colors"
              >
                <svg className="w-5 h-5" fill="white" viewBox="0 0 24 24">
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} GleamWorks. All rights reserved.
          </p>
          <p className="text-gray-500 text-sm">
            Designed with ✨ for spotless experiences
          </p>
        </div>
      </div>
    </footer>
